    ...
    <div>
      <div className='relative sm:mx-0 mx-3' >
        ...
        <div className=' absolute sm:top-48 top-0 text-center sm:left-96 sm:space-y-10 '>
          ...
          <p className='text-white sm:font-bold sm:text-xl  text-sm'>
        ...
        <div className="sm:absolute sm:inset-0 sm:bg-gray-500 sm:opacity-50 sm:rounded-xl">
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 flex sm:ml-0 ml-4">
